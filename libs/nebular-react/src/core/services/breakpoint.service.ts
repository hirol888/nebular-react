...
export const DEFAULT_MEDIA_BREAKPOINTS: NbMediaBreakpoint[] = [
  {
    name: 'xs',
    width: 0,
  },
...
export class NbMediaBreakpointsService {
  ...
  constructor(private breakpoints = DEFAULT_MEDIA_BREAKPOINTS) {
    this.breakpointsMap = this.breakpoints.reduce<{ [breakpoint: string]: number }>((res, b: NbMediaBreakpoint) => {
      res[b.name] = b.width;
      return res;
    }, {});
  }
