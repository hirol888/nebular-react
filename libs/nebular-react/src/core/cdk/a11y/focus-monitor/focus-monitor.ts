...
import { NbPlatform, normalizePassiveListenerOptions, _getEventTarget, _getShadowRoot } from '../../platform';
...
export class FocusMonitor {
  ...
  private _originTimeoutId: NodeJS.Timeout;
  ...
  constructor(
    ...
    @inject(TYPES.InputModalityDetector) private readonly _inputModalityDetector: InputModalityDetector,
    @inject(TYPES.FocusMonitorOptions) @optional() options: FocusMonitorOptions | null,
  ) {
  ...
  monitor(
    ...
    const rootNode = _getShadowRoot(element) || document;
  ...
  focusVia(
    ...
    if (element === focusedElement) {
      this._getClosestElementsInfo(element).forEach(([currentElement, info]) =>
