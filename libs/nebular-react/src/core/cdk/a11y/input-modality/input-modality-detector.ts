...
import { NbPlatform, normalizePassiveListenerOptions, _getEventTarget } from '../../platform';
import {
...
export class InputModalityDetector {
  ...
  constructor(
    @inject(TYPES.NbPlatform) private readonly _platform: NbPlatform,
    @inject(TYPES.InputModalityDetectorOptions) @optional() options?: InputModalityDetectorOptions,
  ) {
    this._options = {
