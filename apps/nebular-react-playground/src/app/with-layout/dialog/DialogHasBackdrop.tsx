...
const DialogHasBackdrop: React.FC = () => {
  ...
  const openWithBackdrop = () => {
    dialogRef.current?.open({ ...config, hasBackdrop: true });
  };

  const openWithoutBackdrop = () => {
    config.hasBackdrop = false;
    dialogRef.current?.open({ ...config, hasBackdrop: false });
  };
  ...
  return (
    <>
      <NbButton onClick={openWithBackdrop}>With backdrop</NbButton>
      <NbButton onClick={openWithoutBackdrop}>Without backdrop</NbButton>
