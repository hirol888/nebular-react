---
title: 'Enable CSS Custom Properties Mode'
group: 'design-system'
slug: '/design-system/enable-css-custom-properties-mode/'
order: 7
---
...
<div class="note note-info section-end">
  ...
  <div class="note-body">
    This guide assumes you already enabled{' '}
    <a href="docs/design-system/enable-customizable-theme">Theme Customization</a>
