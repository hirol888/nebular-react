...
const createEvaIcons = () => Object.entries<OriginalEvaIcon>(eva.icons);

export interface FontIconPackParams {
  packClass?: string;
  iconClassPrefix?: string;
  [name: string]: any;
}

export type SvgIconPacks = Map<string, Map<string, OriginalEvaIcon | SvgFile | string>>;
export type FontIconPacks = Map<string, FontIconPackParams>;

const defaultFontIconPacks: FontIconPacks = new Map();

const defaultSvgIconPacks: SvgIconPacks = new Map();
defaultSvgIconPacks.set('nebular-essentials', new Map(Object.entries(nebularEssentialIcons)));
defaultSvgIconPacks.set('eva', new Map(createEvaIcons()));

export { defaultSvgIconPacks, defaultFontIconPacks };
